...
const  SearchContainer = ()=>{
    ...
    const GetDataTrending = async ()=>{
        ...
        const {data} = await axios.get(`https://api.themoviedb.org/3/search/${typeValue}?api_key=c1493c758679746800b832e6dd544869&page=${pageno}&language=en-US&query=${searchValue}&include_adult=false`);

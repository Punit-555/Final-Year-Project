...
const DetailsContainer = ()=>{
    ...
    const fetchData = async () =>{
        try{
          const {data} = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}?api_key=c1493c758679746800b832e6dd544869&language=en-US`);
          setContent(data);
    ...
    const fetchVideo = async () =>{
        try{
          const {data} = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}/videos?api_key=c1493c758679746800b832e6dd544869&language=en-US`);
    ...
    const creditsFetch = async ()=>{
        try{
          const {data} = await axios.get(`https://api.themoviedb.org/3/${_media_type}/${id}/credits?api_key=c1493c758679746800b832e6dd544869&language=en-US`);
